...
#sed -i -e 's/BLAS_LIBS      =   -lmkl_intel_lp64  -lmkl_sequential -lmkl_core/BLAS_LIBS      =  -L${MKLROOT}\/lib\/intel64 -lmkl_scalapack_ilp64 -lmkl_intel_ilp64 -lmkl_intel_thread -lmkl_core -lmkl_blacs_intelmpi_ilp64 -liomp5 -lpthread -lm -ldl/g' make.inc
